...
export const uiScale$ = bindValue<number>(mod.id, "uiScale", 100);
...
export const deleteTrees$ = bindValue<boolean>(mod.id, "deleteTrees", true);
export const deleteBuildings$ = bindValue<boolean>(
    mod.id,
    "deleteBuildings",
    false
);
export const deleteRoads$ = bindValue<boolean>(mod.id, "deleteRoads", false);
export const deletePaths$ = bindValue<boolean>(mod.id, "deletePaths", false);

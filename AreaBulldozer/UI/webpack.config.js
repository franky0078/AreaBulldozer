...
const {
    ...
    require("./tools/css-presence");


function resolveCsiiUserDataPath() {
    const configuredPath =
        process.env.CSII_USERDATAPATH?.trim();
...
const CSII_USERDATAPATH =
    resolveCsiiUserDataPath();
...
module.exports = {
    ...
    externals: {
        ...
        /*
         * Neu:
         * Standard-CS2-Button und Tooltip.
         */
        "cs2/ui":
            "cs2/ui",
    },
            ...
            apply(compiler) {
                compiler.hooks.done.tap(
                    ...
                    (stats) => {
                        ...
                        console.log(
                            `[AreaBulldozer] UI output: ${OUTPUT_DIR}`
                        );
                    }
                );
            },

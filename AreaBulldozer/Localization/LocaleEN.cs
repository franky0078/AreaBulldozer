    ...
    public class LocaleEN : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "AreaBulldozer.UI.Colors", "Colors" },
                { "AreaBulldozer.UI.OpenColorEditor", "Open color editor" },
                { "AreaBulldozer.UI.CloseColorEditor", "Close color editor" },
                { "AreaBulldozer.UI.ColorEditorTooltip", "Adjusts the selection, confirmation, deletion feedback, selected surface, and invalid polygon colors with a live preview." },
                { "AreaBulldozer.UI.ColorEditor", "Color editor" },
                { "AreaBulldozer.UI.ColorSelection", "Normal selection" },
                { "AreaBulldozer.UI.ColorConfirmation", "Confirmation" },
                { "AreaBulldozer.UI.ColorInvalidPolygon", "Invalid polygon" },
                { "AreaBulldozer.UI.ColorDeletion", "Active deletion" },
                { "AreaBulldozer.UI.ColorSurfaces", "Selected objects" },
                { "AreaBulldozer.UI.ColorPresets", "Color presets" },
                { "AreaBulldozer.UI.ChooseColor", "Choose color" },
                { "AreaBulldozer.UI.ColorRed", "Red" },
                { "AreaBulldozer.UI.ColorGreen", "Green" },
                { "AreaBulldozer.UI.ColorBlue", "Blue" },
                { "AreaBulldozer.UI.ColorHex", "Hex value" },
                { "AreaBulldozer.UI.ResetCurrentColor", "Reset this color" },
                { "AreaBulldozer.UI.ResetAllColors", "Reset all colors" },
